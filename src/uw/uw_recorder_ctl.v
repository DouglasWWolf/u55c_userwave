...
/*
    Provides register acceess for the userwave recorder
*/
...
(
    ...
    output reg[63:0] host_buff_size,
...
//=========================  AXI Register Map  =============================
localparam REG_HOST_BUFF_ADDR_H = 0;
    ...
    // Otherwise, we're not in reset...
        ...
        0:  if (ashi_write) begin
                ...
                case (ashi_windx)
                    ...
                    REG_HOST_BUFF_ADDR_H:   host_buff_addr[63:32] <= ashi_wdata;
...
always @(posedge clk) begin
    ...
    // If we're not in reset, and a read-request has occured...        
        ...
        case (ashi_rindx)
            ...
            REG_HOST_BUFF_ADDR_H:   ashi_rdata <= host_buff_addr[63:32];
